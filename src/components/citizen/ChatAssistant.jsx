  ...
  return (
    <>
        ...
        >
            ...
            {messages.map((msg, i) => (
              <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                ...
                <div
                  ...
                  style={{
                    background: msg.role === 'user' ? '#1e5fb8' : 'white',
              ...
              <div className="flex flex-col gap-2 mt-1">
                ...
                {QUICK_QUESTIONS.map(q => (
                  <button
                    ...
                    className="text-left px-3 py-2 bg-white border border-[#e5e7eb] rounded-xl text-[12px] text-[#1e5fb8] leading-4 hover:bg-[#eff6ff] transition-colors cursor-pointer"
          ...
          <div className="bg-white border-t border-[#e5e7eb] px-3 py-3 flex items-end gap-2 shrink-0">
            <textarea
              ...
              rows={1}
              disabled={loading}
              className="flex-1 bg-[#f3f4f6] border-0 rounded-xl px-3 py-2.5 text-[13px] text-[#1a1a1a] placeholder-[#9ca3af] leading-5 resize-none focus:outline-none focus:ring-2 focus:ring-[#1e5fb8] disabled:opacity-60"
              style={{ maxHeight: 80 }}
            />
            <button
              onClick={() => handleSend()}
      ...
      <button
        ...
        style={{
          background: '#1e5fb8',
          boxShadow: '0 4px 20px rgba(30,95,184,0.4)',
        }}
