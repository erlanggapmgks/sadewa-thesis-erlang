...
export default function RequestDocumentPage() {
  ...
  // ── Online/offline status — checked on mount and on step 2 entry ──────────
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[12px] text-[#92400e] mt-0.5 leading-5">
                        Koneksi internet tidak terdeteksi. Dokumen akan diproses menggunakan <strong>Tesseract OCR</strong> (mesin lokal). Proses mungkin lebih lambat, hasil tergantung kualitas foto KTP.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="px-6 pt-6 pb-4 border-b border-[#e5e7eb]">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div>
                    ...
                    <p className="mt-1 text-[14px] text-[#6b7280]">
                      {aiLoading
                        ? (isOffline ? 'Tesseract OCR sedang membaca dokumen (mode offline)...' : 'Sistem AI sedang membaca dokumen Anda...')
                        : 'Periksa dan konfirmasi data yang dibaca AI'}
                    </p>
                  </div>
                  {/* Engine badge — tampil setelah selesai */}
                  {!aiLoading && aiResult && (
...
// Badge yang menampilkan mesin OCR yang dipakai
        ...
        {AI_STEPS.map((s, i) => (
          <div key={s} className="flex items-center gap-3">
            <div
              ...
              style={{
                background: i < activeStep ? '#16a372' : i === activeStep ? (offline ? '#d97706' : '#1e5fb8') : '#e5e7eb',
              }}
            >
              {i < activeStep
                ? <CheckIcon size={10} />
